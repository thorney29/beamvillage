<html>
	...
	<body>
		...
		<div class="settings-dialog">
			<div class="settings-dialog-inside"></div><button class="button accept-changes button-primary"><?php _e( 'Update', 'runway' ); ?></button>
		</div>
		<div id="titlediv">
			<div id="titlewrap" <?php if(!$this->resolutions['title']){ echo 'style="display:none;"'; } ?>>
				<label class="hide-if-no-js" style="visibility: hidden;" id="title-prompt-text" for="title"><?php _e( 'Enter title here', 'runway' ); ?></label> <input type="text" name="post_title" size="30" tabindex="1" value="<?php echo esc_attr($page['settings']['title']) ?>" id="title" autocomplete="off">
			</div>
				...
				<div id="">
					<div class="nav-tabs-nav">
						<div class="nav-tab-wrapper nav-tabs-wrapper">
							<div class="nav-tabs">
								<a href="javascript:void(0);" class="nav-tab nav-tab-active" data-switchto="elements-list"><?php _e( 'Options', 'runway' ); ?></a> <a href="javascript:void(0);" class="nav-tab" data-switchto="page-global-settings" <?php if(!$this->resolutions['settings']){ echo 'style="display:none;"'; } ?>><?php _e( 'Settings', 'runway' ); ?></a> <?php if(isset($help_tabs_admin)) { ?> <a href="javascript:void(0);" class="nav-tab" data-switchto="page-help-tabs"><?php _e( 'Help tabs', 'runway' ); ?></a> <?php } ?>
							</div>
						</div>
					</div>
					<div class="menu-edit">
								...
								<div class="major-publishing-actions">
									<div class="elements-list tabIn">
										<div id="add-tab" class="new-element ntab button" data-type='tab' <?php if(!$this->resolutions['options-tabs']){ echo 'style="display:none;"'; } ?>>
											<img src="<?php echo FRAMEWORK_URL ?>framework/images/add-icon.png"> <?php _e( 'Tab', 'runway' ); ?>
										</div>
										<div id="add-container" class="new-element ncontainer button" data-type='container' <?php if(!$this->resolutions['options-containers']){ echo 'style="display:none;"'; } ?>>
											<img src="<?php echo FRAMEWORK_URL ?>framework/images/add-icon.png"> <?php _e( 'Container', 'runway' ); ?>
										</div>
										...
										<p class="info">
											<a class="expand-all" href="#">Expand all</a> / <a class="collapse-all" href="#"><?php _e('Collapse all', 'runway'); ?></a>
										</p>
									</div>
									<div class="major-publishing-actions">
